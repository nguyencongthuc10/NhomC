            ...
            <div class="container">
                ...
                <div class="item-top">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/images/aboutus-img-2.jpg" alt="hinh2" class="img-responsive">
                    </div>
                </div>
                </div>
                <div class="row">
                <div class="item-center">
                    <div class="col-md-6 col-xs-12">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/images/aboutus-img-3.jpg" alt="hinh3" class="img-responsive"> 
