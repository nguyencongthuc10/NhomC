    ...
    <div class="container img">
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <a class="img-trans" href=""><img src="<?php echo get_template_directory_uri() ?>/assets/images/module_11_1.jpg" alt=""></a>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <a class="img-trans" href=""><img src="<?php echo get_template_directory_uri() ?>/assets/images/module_11_2.jpg" alt=""></a>
                <div class="img-content">
                    <div class="img-title">
                        <a href="#">Lifestyle</a>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <a class="img-trans" href=""><img src="<?php echo get_template_directory_uri() ?>/assets/images/module_11_3.jpg" alt=""></a>
                <div class="img-content">
                    <div class="img-title">
                        <a href="#">Lifestyle</a>
                    </div>
