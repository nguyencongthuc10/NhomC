      ...
      <div id="tab-hieu" class="container">
        <!-- tab -->
          <ul class="tabs " role="tablist">
              ...
              <li>
                <a href="#hieu1" data-toggle="tab">ADDITIONAL INFORMATION</a>
              </li>
              <li>
                <a href="#hieu3" data-toggle="tab">REVIEWS (0)</a>
             </li>
      </ul>
      <!-- tab-content -->
      ...
      <div class="tab-pane" id="hieu3" >
          ...
          <div class="stars">
              <form >
                ...
                <textarea cols="45" rows="8" class="txt-24"></textarea>
                <!-- row -->
          <div class="row">
            <!-- col-md-6 -->
            <div class="col-md-6">
                <p  class="t2-hh">Name *</p>
                <input class="author" type="text" value="" size="30" >
            </div>
            <!-- col-md-6 -->
            <div class="col-md-6">
